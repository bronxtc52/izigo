...
> 60%-пул, лидерский/структурный/реферальный бонусы, возвраты/сторно V2, админка «План V2»,
> Mini App таб «Мой план V2», партнёрская политика v3.0). 6 волн / 16 задач через `/armada`,
> PR #46 в main. Все 12 V2-флагов ON, паритет V1==V2 15/15, балансы были нулевые, смоук зелёный,
> сьют 908 passed. Движок V2 — `Modules/Calculator/V2` рядом с V1 (`Modules/Calculator`).
> Откат = флип флагов OFF (runbook `docs/runbooks/mh-full-plan-cutover.md`).
> ТЗ/решения: `docs/specs/2026-07-12-mh-full-plan-*`; политика: `docs/marketing-policy/marketing-policy-izigo-v3.*`.
>
> **Возможные следующие итерации** (не начаты, требуют решения владельца): пост-cutover
> мониторинг/снятие заморозки выводов; хвосты P2 из P1-hardening; 14 dependabot-уязвимостей
> (1 high) на default-ветке.

---

# [АРХИВ] Закрытие P1 продакшн-ревью (production hardening)
